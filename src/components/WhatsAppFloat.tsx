...
export function WhatsAppFloat() {
  ...
  const handleWhatsAppClick = () => {
    const phone = '5516999655000';
    const message = encodeURIComponent(
      'Olá! Gostaria de saber mais sobre as soluções de energia solar da DOT Energia.'
    );
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 right-6 z-50 w-14 h-14 bg-gradient-to-r from-green-500 to-green-600 rounded-full shadow-lg hover:shadow-xl transform transition-all duration-300 flex items-center justify-center group ${
        isVisible
